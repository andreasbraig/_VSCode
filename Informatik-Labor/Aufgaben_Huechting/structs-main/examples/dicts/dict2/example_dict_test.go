...
func ExampleSynonymDe() {
	...
	entry3 := Entry{De: "Wald", En: "wood"}
	entry4 := Entry{De: "Holz", En: "wood"}
	entry5 := Entry{De: "Wald", En: "wood"}

	// Hinzufügen der Einträge zu `dict1`:
	dict1.Append(entry1, entry2, entry3, entry4, entry5)

	fmt.Println(dict1.SynonymDe("Wald"))
...
func ExampleSynonymEn() {
	...
	fmt.Println(dict1.SynonymEn("wood"))
